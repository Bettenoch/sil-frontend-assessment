...
import { type AlbumCreate, AlbumsService, type ApiError } from "../../client"
...
const CreateAlbum = ({ userId }: { userId: string }) => {
	...
	const {
		...
		defaultValues: {
			title: "",
			cover_photo:
				"https://images.unsplash.com/photo-1711314166194-ecd3887a26ab?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTh8fG9sZCUyMGJvb2tzfGVufDB8fDB8fHww",
			description: "",
		},
	})
